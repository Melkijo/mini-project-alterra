         ...
         <div className="flex flex-col-reverse items-center  my-14 max-w-[90rem] mx-auto px-4   sm:flex-row ">
            <div>
               <p className="text-6xl font-bold mb-7 leading-snug text-gray-800">
                  Peluang <span className="text-blue-500"> Beasiswa</span>{" "}
         ...
         <div className=" max-w-[90rem] mx-auto px-8  py-8 gap-10  mb-24 mt-20  grid grid-cols-1 md:grid-cols-2 items-center rounded-md shadow-xl bg-blue-500">
            ...
            <div className="text-white">
               ...
               <p className=" w-full sm:w-11/12 line-clamp-6">
                  Kami adalah sebuah start up yang berfokus pada penyediaan
                  informasi beasiswa untuk masyarakat Indonesia. Berawal dari
                  kesadaran akan banyaknya anak-anak muda yang sulit mendapatkan
                  akses ke pendidikan berkualitas karena faktor finansial, kami
                  berkomitmen untuk menjadi solusi terdepan dalam memberikan
                  informasi beasiswa yang akurat, terpercaya, dan mudah diakses.
                  dan juga kami dari beasiswakita ingin memberikan rekomendasi
                  beasiswa kepada para pengguna kami
               </p>
               <Link to={"/tentang"}>
